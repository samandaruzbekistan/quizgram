                ...
                <div class="col-md-4 col-xl-3">
                    <div class="card mb-3">
                        ...
                        <div class="card-body text-center">
                            <img src="{{ asset('img/avatars/samandar.jpg') }}" alt="Christina Mason" class="img-fluid rounded-circle mb-2" width="128" height="128">
                            <h5 class="card-title mb-0">Samandar Sariboyev</h5>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-1">
                                    <i class="align-middle me-1" data-feather="user"></i>F.I.SH: <a href="#">Samandar Sariboyev</a>
                                </li>
                                <li class="mb-1">
                                    <i class="align-middle me-1" data-feather="briefcase"></i>Ish joyi: <a href="#">Gold Apps</a></li>
                                <li class="mb-1"><i class="align-middle me-1" data-feather="phone"></i>Telefon: <a href="#">+998 97 567 20 09</a></li>
                            </ul>
                        </div>
                        <hr class="my-0">
                    </div>
